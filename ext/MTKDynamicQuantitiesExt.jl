...
using ModelingToolkit, Symbolics, SymbolicUtils, JumpProcesses
using ModelingToolkit: get_unit, check_units, __get_unit_type, validate, VariableUnit,
...
function ModelingToolkit.__generate_variable_with_unit(metadata_with_exprs, name, vv, def)
