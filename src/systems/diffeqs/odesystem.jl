...
struct ODESystem <: AbstractODESystem
    ...
    substitutions::Any
    """
    clock_partitioning: The result of clock_inference.
    """
    clock_partitioning::Any
    ...
    function ODESystem(deqs, iv, dvs, ps, var_to_name, ctrls, observed, tgrad,
                       ...
                       substitutions = nothing, clock_partitioning = nothing;
        ...
        new(deqs, iv, dvs, ps, var_to_name, ctrls, observed, tgrad, jac,
            ...
            substitutions, clock_partitioning)
    end
end
...
function ODESystem(deqs::AbstractVector{<:Equation}, iv, dvs, ps;
    ...
    ODESystem(deqs, iv′, dvs′, ps′, var_to_name, ctrl′, observed, tgrad, jac,
              ...
              metadata, nothing, nothing, clock_partitioning; checks = checks)
end
