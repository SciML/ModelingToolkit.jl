...
struct ODESystem <: AbstractODESystem
    ...
    substitutions::Any
    """
    Miscellaneous arguments to be passed on to the `ODEProblem` or `solve`.
    """
    kwargs

    function ODESystem(deqs, iv, dvs, ps, var_to_name, ctrls, observed, tgrad,
            jac, ctrl_jac, Wfact, Wfact_t, name, systems, defaults,
            torn_matching, connector_type, connections, preface, events, kwargs,
        ...
        new(deqs, iv, dvs, ps, var_to_name, ctrls, observed, tgrad, jac,
            ...
            connector_type, connections, preface, events, tearing_state, substitutions, kwargs)
    end
end
...
function ODESystem(
    ...
    ODESystem(deqs, iv′, dvs′, ps′, var_to_name, ctrl′, observed, tgrad, jac,
              ...
              connector_type, nothing, preface, cont_callbacks, kwargs; checks=checks)
end
