...
const REEXPORTED_API = (
    ...
    :alg_equations, :AnalysisPoint, :analytically_integrated, :apply_to_variables,
    :arrays_scalarized, :asdigraph,
    ...
    :reorder_dimension_by_tunables!, :respecialize, :Sample, :SampleTime,
    :ScalarizeArraysCtx, :SDESystem,
