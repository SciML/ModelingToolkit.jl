...
const REEXPORTED_API = (
    ...
    :compose, :connect, :Connection, :ConnectionEdge, :ConnectionNetwork, :constraints,
    ...
    :MTKVariableTypeCtx, :multiconnect, :namespace_equations, :network_edge_ports,
    :noise_to_brownians, :NonlinearSystem,
