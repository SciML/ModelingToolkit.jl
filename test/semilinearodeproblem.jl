...
@testset "Astrochem model" begin
    ...
    @testset "stiff_linear: $stiff_linear, stiff_quadratic: $stiff_quadratic, stiff_C: $stiff_C" for (stiff_linear, stiff_quadratic, stiff_C) in Iterators.product(
        [false, true], [false, true], [false, true])
        kwargs = (; stiff_linear, stiff_quadratic, stiff_C)
        if stiff_linear == stiff_quadratic == stiff_C
            if stiff_linear
