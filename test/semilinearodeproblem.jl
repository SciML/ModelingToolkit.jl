...
@testset "Astrochem model" begin
    ...
    @testset "stiff_linear: $stiff_linear, stiff_quadratic: $stiff_quadratic, stiff_nonlinear: $stiff_nonlinear" for (stiff_linear, stiff_quadratic, stiff_nonlinear) in Iterators.product(
