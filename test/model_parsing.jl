...
using ModelingToolkit: get_connector_type, get_initial_conditions, get_gui_metadata,
...
sol = solve(prob)
defs = ModelingToolkit.initial_conditions(rc)
...
@testset "Argument order" begin
    ...
    defs = ModelingToolkit.initial_conditions(ordermodel)
...
@testset "Nonnumeric parameters" begin
    ...
    @test value(ModelingToolkit.initial_conditions(sys)[@nonamespace sys.p]) == CustomStruct()
end
