...
@test value(SymbolicUtils.substitute(value(2x + y == 1), Dict(x => 0.0, y => 0.0); fold = Val(true))) === false
@test value(SymbolicUtils.substitute(value(2x + y == 1), Dict(x => 0.0, y => 1.0); fold = Val(true))) === true
