...
using ModelingToolkitBase: get_metadata, MTKParameters,
...
for p in [prob1, prob14]
    @test p.p isa SciMLBase.DespecializedParameters
    p.ps[k₁] ≈ 0.04
    p.ps[k₂] ≈ 3.0e7
    p.ps[k₃] ≈ 1.0e-4
...
@testset "symbolic remake with nested system" begin
    ...
    @test prob_new.p isa SciMLBase.DespecializedParameters
