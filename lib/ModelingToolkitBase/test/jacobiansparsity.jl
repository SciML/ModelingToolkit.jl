using ModelingToolkitBase, SparseArrays, OrdinaryDiffEq, DiffEqBase, BenchmarkTools
...
lim(a, N) = ModelingToolkitBase.ifelse(a == N + 1, 1, ModelingToolkitBase.ifelse(a == 0, N, a))
...
if @isdefined(ModelingToolkit)
    ...
    @testset "Issue#3871: Sparsity with observed derivatives" begin
        ...
        ts = ModelingToolkitBase.get_tearing_state(sys)
        for ieq in 1:2
            vars1 = ts.fullvars[ModelingToolkitBase.BipartiteGraphs.𝑠neighbors(ts.structure.graph, ieq)]
